                    ...
                    child: RichText(
                      text: const TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              text:
                                  ' is a free English learning platform with many new functions and easy to use. Its design helps users to pass the lessons and also helps to translate text, documents.',
                              style: TextStyle(
